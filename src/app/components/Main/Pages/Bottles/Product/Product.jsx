...
const Product = ({ bottleData = {} }) => {

    const {

        img,
        name = "Nom de la bouteille",
        domain = "Domaine de la bouteille",
        color = "couleur",
        region = "Région",
        grape = "cépage",
        description = "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Saepe doloribus corporis totam? Saepe esse quia quos recusandae earum tempora ad praesentium maxime aut, asperiores at."
...
const Characteristic = ({
    ...
    name = "?? Nom ??",
    svg = <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28"><path fill="#A8A5A3" fill-rule="evenodd" d="M23.382 21.99c0 .678-.355 1.302-.95 1.669l-.039.027c-.434.24-3.472 1.814-8.393 1.814-4.92 0-7.958-1.573-8.393-1.814-.013-.01-.026-.018-.04-.027a1.958 1.958 0 0 1-.95-1.67V4.474c0-1.088.895-1.973 1.994-1.973h14.777c1.1 0 1.994.885 1.994 1.973V21.99zM21.388 1.5c1.651 0 2.994 1.334 2.994 2.973V21.99c0 1-.505 1.92-1.355 2.476a.513.513 0 0 1-.065.047c-.135.08-3.364 1.987-8.962 1.987s-8.827-1.906-8.962-1.987a.535.535 0 0 1-.067-.047 2.952 2.952 0 0 1-1.354-2.476V4.473c0-1.64 1.344-2.973 2.994-2.973h14.777zm-5.064 19.622a.378.378 0 0 1-.377.378h-3.894a.378.378 0 0 1-.377-.378v-8.64c0-.942.591-1.81 1.472-2.162.002 0 .003-.002.004-.003a.471.471 0 0 0 .126-.082c.012-.009.027-.015.038-.025.022-.023.035-.052.053-.078.018-.027.041-.05.054-.08.006-.014.005-.03.01-.045a.492.492 0 0 0 .03-.147v-.005l-.042-4.296 1.115-.058v4.354l.001.005a.52.52 0 0 0 .03.146c.005.014.004.032.01.046.012.028.034.05.051.076.02.028.032.058.056.082.01.01.025.015.036.024.04.033.08.064.127.083l.004.003a2.35 2.35 0 0 1 1.473 2.162v8.64zm-.788-11.577V5.501a.95.95 0 0 0-.958-.942h-1.157a.951.951 0 0 0-.958.942v4.044a3.301 3.301 0 0 0-1.787 2.937v8.64c0 .76.617 1.378 1.377 1.378h3.894a1.38 1.38 0 0 0 1.377-1.378v-8.64a3.302 3.302 0 0 0-1.788-2.937z"></path></svg>,
    stats = "..., ..., ..., ..."
    ...
    return (
        <div className="characteristic">
            ...
            <div className="characteristic__details">
                <h4 className="characteristic__name">{name}</h4>
                <p className="characteristic__stats">{stats}</p>
            </div>
        </div>
    );
}
