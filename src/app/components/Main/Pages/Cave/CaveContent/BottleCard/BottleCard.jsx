...
import Product from "../../../Bottles/Bottle/Product";

const BottleCard = ({ removeBottle, openModal, name, vintage, domain, description, _id }) => {
    ...
    return (
        <motion.li
            ...
            exit={{ opacity: 0, scale: 0, rotateZ: "90deg" }}
        
        className="bottle-cave">
            <svg className="bottle-cave__svg" viewBox="46 0 256 512">
            ...
            <div className="bottle-cave__details">
                <h2 className="bottle-cave__name">{name} - {vintage}</h2>
                <div className="bottle-cave__domain">
                ...
                <div className="bottle-cave__buttons">
                    <button onClick={_ => openModal("", <Product bottleData={{
                    ...
                    <button onClick={_ => openModal("Êtes-vous sûr ?", (
                        <div className="plop">
                            <button className="--wewine-btn" onClick={_ => removeBottle(_id)}>Oui supprimer</button>
                        </div>
                    ))}>Supprimer</button>
                </div>
            </div>
